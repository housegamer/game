...
def win(current_game):
	...
	for row in game:
		print(row)
		if all_same(row):
			print(f'winner {row[0]} is the winner horizontally')
			return True 
	# Diagonal
	diags= []
...
def game_board(game_map, player=0,row=0, column=0, just_dislapy=False):
	try:
...
while play:
	...
	game_won = False
	game, _ = game_board(game, just_dislapy = True)
